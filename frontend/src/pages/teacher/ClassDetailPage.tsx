...
function IconUsers() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M16 11a3 3 0 1 0-2.999-3A3 3 0 0 0 16 11Z" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" />
      <path d="M8 11a3 3 0 1 0-2.999-3A3 3 0 0 0 8 11Z" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" />
      <path d="M3.5 20c.6-3.4 3.1-5 6.5-5" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M20.5 20c-.6-3.4-3.1-5-6.5-5" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function IconHelp() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M12 21a9 9 0 1 0-9-9 9 9 0 0 0 9 9Z" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" />
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M12 17.6h.01" stroke="rgba(255,255,255,0.9)" strokeWidth="2.6" strokeLinecap="round" />
    </svg>
  );
}
...
function IconChart() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M4 19h16" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M7 19V11" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M12 19V7" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M17 19V14" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
function IconDoc() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M7 3h7l3 3v15H7V3z" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M14 3v4h4" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M9 12h6" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M9 15h6" stroke="rgba(255,255,255,0.9)" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
export default function ClassDetailPage() {
  ...
  const results = useMemo(
    () => [
      { id: "r1", quiz: "Quiz 1", student: "Su Yi Phyo", score: "10/10", date: "21.01.2025" },
      { id: "r2", quiz: "Quiz 1", student: "Su Yi Phyo", score: "10/10", date: "21.01.2025" },
      { id: "r3", quiz: "Quiz 1", student: "Su Yi Phyo", score: "10/10", date: "21.01.2025" },
    ],
    []
  );
  ...
  return (
    <div style={{ padding: "28px 36px", color: "rgba(255,255,255,0.95)" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        <div style={{ opacity: 0.7, fontSize: 14, marginBottom: 8 }}>Teacher Class Detail</div>
              ...
              {tab === "createQuiz" && (
                <div style={{ padding: 16, opacity: 0.9 }}>
                  ...
                  <div style={{ opacity: 0.8, lineHeight: 1.6 }}>
                    UI-only now. Later connect with Quiz Generator (Suyi part).
                  </div>
        ...
        <div style={{ marginTop: 14, opacity: 0.65, fontSize: 13 }}>
          Route example: <b>/teacher/class/21020105</b>
        </div>
      </div>
    </div>
  );
