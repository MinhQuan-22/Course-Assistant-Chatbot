...
📋 GIỚI THIỆU
--------------------------------------------------------------------------------
Course Assistant Chatbot (3N) là hệ thống quản trị học tập (LMS) kết hợp công 
nghệ AI RAG (Retrieval Augmented Generation) giúp tự động hóa quá trình hỏi đáp 
...
================================================================================
                    LƯU Ý QUAN TRỌNG VỀ CÁC THƯ MỤC ĐÃ XÓA
================================================================================
...
📊 KẾT QUẢ: Dung lượng project giảm từ ~1.5GB xuống còn ~37MB (giảm 97.5%)
...
│                 │                                  │          │ - Xem điểm số                       │
├─────────────────┼──────────────────────────────────┼──────────┼─────────────────────────────────────┤
│ STUDENT         │ binh.pham@student.tdtu.edu.vn    │ 123456   │ - Tương tự như tài khoản Student    │
│ (Sinh viên)     │ hoặc: binh.pham                  │          │   bên trên                          │
├─────────────────┼──────────────────────────────────┼──────────┼─────────────────────────────────────┤
│ STUDENT         │ chi.vo@student.tdtu.edu.vn       │ 123456   │ - Tương tự như tài khoản Student    │
│ (Sinh viên)     │ hoặc: chi.vo                     │          │   bên trên                          │
└─────────────────┴──────────────────────────────────┴──────────┴─────────────────────────────────────┘
...
├── README.txt                  # Hướng dẫn cài đặt (file này)
